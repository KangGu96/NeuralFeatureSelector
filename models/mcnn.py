...
class Classifier_MCNN:
    ...
    def __init__(self, output_directory, input_shape,num_class,verbose=0, build=True):
        ...
        self.model = self.build_model(input_shape, num_class, 2, 3)
    ...
    def build_model(self, input_shapes, nb_classes, pool_factor, kernel_size):
        ...
        output_layer = keras.layers.Dense(units=nb_classes, 
            kernel_initializer='glorot_uniform', activation="softmax")(fully_connected)
